...
Private Sub DrawList()
  ...
  Dim i As Long
    ...
    Call APIRectangle(iScr.hDC, 0, 0, ScaleWidth - 1, ScaleHeight - 1, _
        m_SelectBorderColor)
...
Private Sub UserControl_Resize()
    ...
    Height = (m_VisibleRows) * m_tmpItemHeight * Screen.TwipsPerPixelX + (Height - ScaleHeight * _
    ...
    With Bar
        On Error Resume Next
        Call .Move(ScaleWidth - .Width - 1, 1, .Width, ScaleHeight - 2)
        .Visible = 0
    End With
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("SelectListBorderColor", m_SelectListBorderColor, _
        defSelectListBorderColor)
