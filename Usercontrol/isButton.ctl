...
Private Sub DrawCaption()
  ...
  DrawText UserControl.hDC, m_sCaption, Len(m_sCaption), m_txtRect, lwFontAlign
...
Private Sub DrawKeramikButton(m_iState As isState)
...
Private Sub UserControl_Resize()
  ...
  Select Case m_CaptionAlign
    Case isbCenter
      ...
      lwFontAlign = DT_CENTER Or DT_VCENTER Or DT_SINGLELINE 'DT_WORDBREAK
    Case isbleft
  ...
  BuildRegion
  Refresh
  DrawText UserControl.hDC, m_sCaption, Len(m_sCaption), tmpRect, lwFontAlign
End Sub
